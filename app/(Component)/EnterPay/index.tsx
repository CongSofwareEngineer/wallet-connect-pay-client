    ...
    <ContainerContent>
      <div className='flex flex-col gap-8 items-center justify-between w-full h-full'>
        <div className='flex flex-col  items-center'>
          {/* Header */}
          <h1 className='text-3xl font-bold   '>{translate('walletConnectPay.posApp')}</h1>
          ...
          <div className='flex items-center gap-2 '>
            ...
            <span className='text-lg font-medium'>{translate('walletConnectPay.pay')}</span>
          </div>
        </div>
        ...
        <div className='flex flex-col flex-1 gap-6 w-full '>
          ...
          >
            ...
            <span className='text-sm text-slate-300 font-medium'>{translate('walletConnectPay.newSale')}</span>
          </button>
          ...
          >
            ...
            <span className='text-sm text-slate-300 font-medium'>{translate('walletConnectPay.activity')}</span>
          </button>
        </div>
      </div>
    </ContainerContent>
